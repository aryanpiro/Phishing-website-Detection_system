...
st.write('**Project by Kumar Aryan** | This ML-based app is developed for educational purposes. Objective of the app is detecting phishing websites only using content data. Not URL!'
...
with st.expander("PROJECT DETAILS"):
    ...
    st.write('For this educational project, a comprehensive dataset was created with defined features - some from literature and some based on manual analysis. '
             'The requests library was used to collect data, and BeautifulSoup module to parse and extract features from HTML content.')
    st.write('**Project Author:** Kumar Aryan')
