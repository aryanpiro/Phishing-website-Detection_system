...
@st.cache_resource
def train_models():
    """Train all ML models and return them with results"""
...
ab_model = models_data['ab_model']
svm_model = models_data['svm_model']
nb_model = models_data['nb_model']
nn_model = models_data['nn_model']
kn_model = models_data['kn_model']
df_results = models_data['df_results']
